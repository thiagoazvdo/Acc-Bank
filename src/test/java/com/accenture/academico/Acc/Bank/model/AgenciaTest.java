...
class AgenciaTest {
    ...
    void testEqualsObject() {
        ...
        Agencia agencia1 = new Agencia(1L, "Banco do Brasil UFCG", "UFCG", "3333-2222");
        Agencia agencia2 = new Agencia(1L, "Banco do Brasil UFCG", "UFCG", "3333-2222");
        assertEquals(agencia1, agencia2);

        // Teste de desigualdade com IDs diferentes
        Agencia agencia3 = new Agencia(2L, "Banco do Brasil UFCG", "UFCG", "3333-2222");
    ...
    void testEqualsNulo() {
        ...
        Agencia agencia1 = new Agencia(null, "Banco do Brasil UFCG", "UFCG", "3333-2222");
        Agencia agencia2 = new Agencia(null, "Banco do Brasil UFCG", "UFCG", "3333-2222");
        assertEquals(agencia1, agencia2);

        // Teste de desigualdade quando um ID é null e o outro não
        Agencia agencia3 = new Agencia(1L, "Banco do Brasil UFCG", "UFCG", "3333-2222");
        assertNotEquals(agencia1, agencia3);
    }
	...
	void testEqualsWithDifferentCanEqual() {
	    ...
	    Agencia agenciaSubclass = new Agencia(1L, "Banco do Brasil UFCG", "UFCG", "3333-2222") {
	        @Override
